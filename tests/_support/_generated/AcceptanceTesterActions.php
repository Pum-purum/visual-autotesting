<?php  //[STAMP] cc46adade2df2165e0e7c1b256b9cbb8
...
trait AcceptanceTesterActions
{
     ...
     * @param string $name
	 * @return array
     * @see \Helper\Acceptance::getPage()
     */
    public function getPage(string $name): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPage', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::addPageToOutput()
     */
    public function addPageToOutput(\Codeception\Example $example): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('addPageToOutput', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::preComment()
     */
    public function preComment(string $page, string $message) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('preComment', func_get_args()));
    }
     ...
     *
     * @param string $page
     * @see \Helper\Acceptance::preCommentVisualDeviation()
     */
    public function preCommentVisualDeviation(string $page): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('preCommentVisualDeviation', func_get_args()));
    }
     ...
     *
     * @param string $page
     * @see \Helper\Acceptance::clearPreComments()
     */
    public function clearPreComments(string $page): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('clearPreComments', func_get_args()));
    }
